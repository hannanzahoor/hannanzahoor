...
- Built a full-stack e-commerce platform using **React, Node.js, MongoDB, and TensorFlow**
- Integrated **AI-driven product recommendations**
- Focused on scalability and personalized user experience

---

### 💳 E-Wallet Software
- Developed a secure digital wallet using **Java, MySQL, and REST APIs**
- Implemented **encryption for secure transactions**
- Designed for **high scalability and smooth user experience**

---

### 📊 Data Speed Geo-Location Predictor
- Built using **Python, SQL, and data visualization libraries**
- Analyzes network provider speeds and recommends the fastest option
